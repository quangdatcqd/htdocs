        ...
        <div class="bg-dark h-100 p-4">
            ...
            <form action="/zalo/submit-check-vc/" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" autofocus class="form-control" id="Cookie" placeholder="Nhập Cookie" value="h5token=" name="cookie">
                ...
                <div class="row">
                    <!-- <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="api" name="api" placeholder="Nhập api" value="<if (isset($_SESSION['api'])) echo $_SESSION['api'];
                                                                                                                    else echo ''; ?>" aria-describedby="api">

                    </div> -->
                    <div class="col-sm-6">
                        <label for="sdt" class="form-label mb-0 text-light">Số lượng bạn bè</label>
                        <input type="number" class="form-control" id="slbb" name="slbb" placeholder="Số lượng bạn bè" aria-describedby="bb">


                    </div>
                    <div class="form-check form-switch m-0 col-sm-6 d-flex align-items-center justify-content-center">
                        <input class="form-check-input pe-auto " checked type="checkbox" name="addzlp" <?= $_SESSION['check'] ?> id="addzlp">
