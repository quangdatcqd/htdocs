<div class="row">
    ...
    ?>
        <div class="container px-3 h-1500 ">
                    ...
                    <table class="table text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center border-top-0 hidec">ĐD</th>
                                <th class="text-center border-top-0 hidec">
                                    <input onkeyup="myFunction3()" id="from" value="0" class=" btn border-primary text-left" style="width: 50px;"   rows="3">
                                    <input onkeyup="myFunction3()" id="to" value="100" class=" btn border-primary text-left" style="width: 50px;"  rows="3">
                                </th>
                                <th class="text-center border-top-0 hidec">
                                    <input onkeyup="myFunction3()" id="filter" class="note btn border-primary text-left" cols="30" rows="3">
                                </th>
                                <th class="text-center border-top-0">Tên</th>
                                <th class="text-center border-top-0">Ảnh</th>
                                <th class="text-center border-top-0 hidec"><select name="row" id="row" class="btn border-primary">
                                ...
                                <th class="text-center border-top-0" ><label for="hidecookie">Hide</label><input type="checkbox" class="hidecookie form-check-input ms-2" name="hidecookie" id="hidecookie"></th>
