    ...
    <div class="col-md-6 col-lg-6 pb-5 h-100 col-sm-6 container  mt-3">
        ...
        <div class="bg-dark h-100 p-4">
            ...
            <form action="/zalo/mapbank/" method="post">
                ...
                <div class="mb-3">
                    <label for="banktype" class="form-label text-light mb-0">Tên Ngân Hàng</label>
                    <input type="text" class="form-control" id="banktype" autofocus placeholder="Nhập Tên Ngân Hàng" value="<?php if (isset($_SESSION['banktype'])) echo $_SESSION['banktype'];
                                                                                                                            else echo 'CIMB'; ?>" name="banktype">
                </div>
